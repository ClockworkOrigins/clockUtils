...
TEST(Compression, HuffmanFixed) {
	...
	std::string compressed = compressor.compress(before);
	std::string compressedLong = compressor.compress(beforeLong);
...
TEST(Compression, HuffmanComparison) {
	...
	std::string compressedGeneric = compressorGeneric.compress(before);
	std::string compressedLongGeneric = compressorGeneric.compress(beforeLong);

	std::string compressedFixed = compressorFixed.compress(before);
	std::string compressedLongFixed = compressorFixed.compress(beforeLong);
