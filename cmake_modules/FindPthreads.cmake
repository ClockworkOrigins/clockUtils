...
#
SET(_PTHREADS_INCLUDE_SEARCH_DIRS
"$ENV{ProgramFiles}/pthreads/include"
)
FIND_PATH(PTHREADS_INCLUDE_DIR
      NAMES	    pthread.h
      HINTS         ${_PTHREADS_INCLUDE_SEARCH_DIRS})
...
SET(_PTHREADS_LIBRARIES_SEARCH_DIRS
"$ENV{ProgramFiles}/pthreads/lib"
)
FIND_LIBRARY(PTHREADS_LIBRARY ${names}
    DOC "The Portable Threads Library"
    HINTS  ${_PTHREADS_LIBRARIES_SEARCH_DIRS})
